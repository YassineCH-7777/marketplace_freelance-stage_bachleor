...
export const updateFreelancerServiceLocation = (id, data) => API.post(`/freelancer/services/${id}/location`, data);
...
export const openFreelancerOrderDispute = (id, data) => API.put(`/freelancer/orders/${id}/dispute`, data);
